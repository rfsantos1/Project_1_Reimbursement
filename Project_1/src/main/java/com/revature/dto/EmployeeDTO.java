...
public class EmployeeDTO {
	...
	public EmployeeDTO(int id, String username, String password, String firstName, String lastName, String email, EmployeeRole employeeRole) {
		this.id = id;
	...
	public String toString() {
		return "EmployeeDTO [id=" + id + ", username=" + username + ", password=" + password + ", firstName="
				+ firstName + ", lastName=" + lastName + ", email=" + email + ", employeeRole=" + employeeRole + "]";
	}
